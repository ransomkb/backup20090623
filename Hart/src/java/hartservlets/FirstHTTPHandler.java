...
public final class FirstHTTPHandler extends HttpServlet
{
		...
		throws ServletException, IOException
	{
		...
		{ 
            ...
            res.sendRedirect("/Hart/front_page.jsp"); // redirects to first page of site
		...
		throws ServletException, IOException
	{
		...
		else if(req.getParameter("addwordsets") != null) 
		{
			...
			//ss.goBack = "/Hart/front_pageE.jsp";
			ss.userID = ss.sessionId;
			ss.role = "sampler";
			
			ss.goBack = "/Hart/front_page.jsp";
		...
		// FIX THIS SO CAN GET SAMPLER FROM EIKEN STUFF :: done?
			 handle = BookMethods.handleSample(set, typ, ss);
		}
		else 
		{
			ss.goBack = "/Hart/front_page.jsp";
