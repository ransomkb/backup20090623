...
%>
	...
	<!-- Section Header -->
      <form name="sample" method="post" accept-charset="UTF-8" action="/Hart/FirstHTTPHandler">
       
        <table width="650" border="0" cellpadding="0" align="center" >
            <tr>
                <td>
                        <p class="center"><%= ss.exp.getExp47() %></p>
                </td>
                <td class="center">
                        <%= sel.getSelect8(x) %>
                </td>
                <td>
                        <p class="center"><%= ss.exp.getExp48() %></p>
                </td>
                <td class="center">
                        <%= sel.getSelect11(x) %>
                </td>
                <td>
                        <p class="center"><%= ss.exp.getExp49() %></p>
                </td>
                <td>
                        <%= ss.exp.roundButton(ss.exp.getBut10()) %>
                </td>
            </tr>
        </table>
      </form>
